                ...
                case 'ID3 ':// ID3-meta-data
                    return _this.tokenizer.readToken(new Token.BufferType(header.size))
                        ...
                        return strtok3.fromStream(id3stream).then(function (rst) {
                            return ID3v2Parser_1.ID3v2Parser.getInstance().parse(rst, _this.options).then(function (id3) {
                                _this.metadata.format.headerType = id3.format.headerType;
                                _this.metadata.native = id3.native;
                            });
                        });
                    });
